...
public class CorneliusMovementController : MonoBehaviour
{
    #region MOVEMENT CONTROLLER
    /// <summary>
    /// Note: Although this section was imported, some parts of the script were 
    /// altered to change the mechanics slightly and to complete the Learning 
